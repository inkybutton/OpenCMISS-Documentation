...
\newcommand{\commutation}[2]{\ensuremath{ %
 \sqbrac{#1,#2} %
}} %% commutation e.g. \commutation{A,B} => [A,B]
\newcommand{\conjugate}[1]{\ensuremath{ %
    \overline{#1} %                                _
}} %% complex conjugate e.g. \conjugate{Z} => Z
\newcommand{\const}[1]{\ensuremath{\mathrm{#1}}} % constant
\newcommand{\cont}[1]{\ensuremath{C^{#1}}} % continuity e.g. \cont{1} => C^1
\newcommand{\gcont}[1]{\ensuremath{G^{#1}}} % geometric continuity e.g. \gcont{1} => G^1
...
\newcommand{\intevaluated}[3]{\ensuremath{ %
    \displaystyle\sqbrac{#1}_{#2}^{#3} %
}} % display evaluated integral with limits e.g. \intevaluated{xxx}{a}{b} => [xxx]_a^b
...
\newcommand{\tensorrank}[2]{%
rank(#1,#2)%
} % tensorrank e.g., \tensorrank(m,n) => rank(m,n)
...
\newcommand{\jacobian}[2]{\ensuremath{ %
    \ifthenelse{\equal{#1}{}}{ %
      \ifthenelse{\equal{#2}{}}{ %
        \matr{J} %
      }{
...
}} % Jacobain. e.g. \jacobain{a}{b} => J_a(b)
...
\newcommand{\lagrangiansymbol}{\ensuremath{ %
    L %
}} % Lagrangian symbol
\newcommand{\lagrangian}[1]{\ensuremath{ %
    \fnof{\lagrangiansymbol}{#1} %
}} % Lagrangian e.g., \lagrangian{u,v} => L(u,v)

%
% Spaces
%
\newcommand{\mathspace}[1]{\ensuremath{ %
    \mathcal{#1} %
}} % mathmatical space e.g., \mathspace{M} => M
\newcommand{\vectorspace}[1]{\ensuremath{ %
    \mathspace{#1} %
}} % vetor space e.g., \vectorspace{V} => V
\newcommand{\dualspace}[1]{\ensuremath{ %
    \vectorspace{#1}^{*} %
}} % dual space e.g., \dualspace{V} => V^*
\newcommand{\lebesguespacesymbol}{\ensuremath{ %
    L %
}} % Lebesque space symbol
\newcommand{\lebesguepspace}[2]{%
  \ifthenelse{\equal{#2}{}}{ %
    \ensuremath{\lebesguespacesymbol^{#1}}
  }{
    \ensuremath{\lebesguespacesymbol^{#1}\pbrac{#2}} %  
...
\newcommand{\sobolevspacesymbol}{\ensuremath{ %
    W
}} % Sobolev space symbol
\newcommand{\sobolevkpspace}[3]{%
  \ifthenelse{\equal{#3}{}}{ %
    \ensuremath{\sobolevspacesymbol^{#1,#2}}
  }{
    \ensuremath{\sobolevspacesymbol^{#1,#2}\pbrac{#3}} %  
}} % Sobolev k,p space e.g., \sobolevkpspace{k,p}{M} =>W^k,p(M)
\newcommand{\hilbertspacesymbol}{\ensuremath{ %
    H
}} % Hilbert space symbol
\newcommand{\hilbertpspace}[2]{%
  \ifthenelse{\equal{#2}{}}{ %
    \ensuremath{\hilbertspacesymbol^{#1}}
  }{
    \ensuremath{\hilbertspacesymbol^{#1}\pbrac{#2}} %  
...
\newcommand{\vectorfieldspacesymbol}{\ensuremath{ %
    \mathfrak{X} %
}} % space of vector fields symbol
\newcommand{\vectorfieldspace}[1]{\ensuremath{ %
    \fnof{\vectorfieldspacesymbol}{#1} %  
}} % vector field space e.g., \vectorfieldspace{M} => X(M)
\newcommand{\diffformspacesymbol}{\ensuremath{ %
    \bigwedge
}} % space of differential forms symbol
\newcommand{\diffformspace}[2]{%
  \ifthenelse{\equal{#2}{}}{ %
    \ensuremath{{\diffformspacesymbol}^{#1}}
  }{
    \ensuremath{{\diffformspacesymbol}^{#1}\pbrac{#2}} %  
}} % differential form space e.g., \diffformspace{2}{M} =>^2(M)
\newcommand{\ltwodiffformspace}[2]{%
  \ifthenelse{\equal{#2}{}}{ %
    \ensuremath{\lebesguespacesymbol^{2}{\diffformspacesymbol}^{#1}}
  }{
    \ensuremath{\lebesguespacesymbol^{2}{\diffformspacesymbol}^{#1}\pbrac{#2}} %  
}} % L^2 differential form space e.g., \ltwodiffformspace{2}{M} =>L^2 ^2(M)
\newcommand{\honediffformspace}[2]{%
  \ifthenelse{\equal{#2}{}}{ %
    \ensuremath{\hilbertspacesymbol^{1}{\diffformspacesymbol}^{#1}}
  }{
    \ensuremath{\hilbertspacesymbol^{1}{\diffformspacesymbol}^{#1}\pbrac{#2}} %  
...
\newcommand{\manifold}[1]{\ensuremath{ %
    \mathfrak{#1} %
}} % manifold e.g., \manifold{M} => M
\newcommand{\boundary}[1]{\ensuremath{ %
    \del{#1} %
}} % boundary symbol e.g., \boundary{\Omega} => \del\Omega
\newcommand{\configspace}[1]{\ensuremath{ %
    \mathspace{#1} %
}} % 
\newcommand{\embedmanifold}[1]{\ensuremath{ %
  \configspace{#1} %
}} % embedded manifold e.g., \embedmanifold{N} => N
...
\newcommand{\pushforwardsymbol}{\ensuremath{ %
    \triangleright %
}} % push forward symbol e.g., \pushforwardsymbol => \triangleright
\newcommand{\pushforward}[2]{\ensuremath{ %
    #1_{\pushforwardsymbol}#2 %
}} % push forward e.g. \pushforward{M}{v} => M_* v
\newcommand{\pullbacksymbol}{\ensuremath{ %
    \triangleleft %
}} % pull back symbol e.g., \pullbacksymbol => \triangleleft
...
\newcommand{\sharptensorsymbol}{\ensuremath{ %
    \sharp %
}} % sharp tensor symbol e.g.,\sharptensorsymbol => #
\newcommand{\sharptensor}[1]{\ensuremath{ %
    #1^{\sharptensorsymbol}
}} % sharp tensor e.g.,\sharptensor{A} => A^#
\newcommand{\flattensorsymbol}{\ensuremath{ %
    \flat %
}} % flat tensor symbol e.g.,\flattensorsymbol => b
\newcommand{\flattensor}[1]{\ensuremath{#1^{\flattensorsymbol}}} % flat tensor e.g.,
% \flattensor{A} => A^b
...
\newcommand{\numberMandel}[1]{\ensuremath{ %
    \fnof{\Mandelsymbol}{#1} %
}} % number of Mandel e.g., \numberMandel{n} => M(n)
...
\newcommand{\idxnodept}[3]{\ensuremath{ %
    {#1}^{#2#3} %
  }} % Indexed nodal point (without derivative) e.g., \idxnodept{\psi}{i}{n}=> i'th nodal dof of \psi at node n.
\newcommand{\coidxnodept}[3]{\ensuremath{ %
    {#1}^{#3}_{#2} %
  }} % "Covector" Indexed nodal point (without derivative) e.g., \coidxnodept{\psi}{i}{n}=> i'th nodal dof of \psi at node n.
\newcommand{\nodedof}[3]{\ensuremath{ %
  \nodept{#1}{#2}_{,#3} %
...
\newcommand{\barycentricsymb}[0]{\ensuremath{ %
  \lambda%
}} % the symbol for a barycentric coordinate e.g., \barycentricsymb => \lambda
\newcommand{\barycentriccoord}[1]{\ensuremath{ %
  \barycentricsymb^{#1}%
}} % a barycentric coordinate e.g., \barycentriccoord{i} => \lambda^{i}
